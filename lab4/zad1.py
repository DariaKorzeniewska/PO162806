...
print(w2.get_licznik())
print(w2.get_mianownik())
...
print(w1.__add__(w2.p, w2.q))

print(w1.__sub__(w2.p, w2.q))

print(w1.__eq__(w2.p, w2.q))
print(w1.__ne__(w2.p, w2.q))
print(w1.__lt__(w2.p, w2.q))
print(w1.__le__(w2.p, w2.q))
print(w1.__gt__(w2.p, w2.q))
print(w1.__ge__(w2.p, w2.q))
